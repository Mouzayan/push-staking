    ...
    PushCoreStorageV2
{
    ...
    *************** */
    ...
    function transferProtocolFeesToStaking() internal {
        uint256 feesToTransfer = PROTOCOL_POOL_FEES;
        PROTOCOL_POOL_FEES = 0;
        IERC20(PUSH_TOKEN_ADDRESS).approve(address(pushStaking), feesToTransfer);
        pushStaking.receiveProtocolFees(feesToTransfer);
    }
}